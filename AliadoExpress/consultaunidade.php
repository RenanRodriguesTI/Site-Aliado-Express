     ...
     <aside class="barra">
        ...
        <section id="conteudo" style="min-height:600px;width:100%">
            ...
            <section id="Cpanelusuario" class="flutuacaocpanel">
                ...
                <form action="consultaunidade.php" method="post" class="formulario">
     <h3 class="titulo">Consulta de Unidades</h3>
...
<input type="submit" class="bt_acao" name="localizar" value="Localizar"/>
     ...
     <fieldset id="itens-listagem"  >
        ...
        <table id="listagem">
            ...
            <tr><th colspan="4">Unidade</th></tr>
            <tr><td>Código</td><td>Nome</td><td>Cidade</td><td>Operação</td></tr>
            <?=$tabela?>
        </table>
    </fieldset>
</form>
